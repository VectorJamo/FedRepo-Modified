...
from paths import tumor_fpaths
from utils import load_pickle


def load_tumor_data(dataset, combine=True):
    ...
    """
    train_xs, train_ys = [], []
    for fpath in tumor_fpaths[dataset]["train_fpaths"]:
    ...
    test_xs, test_ys = [], []
    for fpath in tumor_fpaths[dataset]["test_fpath"]:
        infos = load_pickle(fpath)
